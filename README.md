...
```swift
.package(url: "https://github.com/codedaptive/moot-semantics.git", from: "1.0.31-rc.1")
```
...
```toml
[dependencies]
<crate-name> = { git = "https://github.com/codedaptive/moot-semantics", tag = "v1.0.31-rc.1" }
```
